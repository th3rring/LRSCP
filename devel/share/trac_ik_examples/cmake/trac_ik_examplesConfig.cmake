...
if("TRUE" STREQUAL "TRUE")
  set(trac_ik_examples_SOURCE_PREFIX /home/ubuntu/dev/lrscp_ws/src/trac_ik/trac_ik_examples)
  set(trac_ik_examples_DEVEL_PREFIX /home/ubuntu/dev/lrscp_ws/devel)
  ...
  set(trac_ik_examples_INSTALL_PREFIX /home/ubuntu/dev/lrscp_ws/install)
...
if(NOT "/usr/include;/usr/include/eigen3;/opt/ros/kinetic/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'trac_ik_examples' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/dev/lrscp_ws/src/trac_ik/trac_ik_examples/${idir}'.  Ask the maintainer 'Patrick Beeson <pbeeson@traclabs.com>' to fix it.")
    endif()
    _list_append_unique(trac_ik_examples_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "/usr/lib/aarch64-linux-gnu/libboost_date_time.so;/opt/ros/kinetic/lib/liborocos-kdl.so.1.3.0")
